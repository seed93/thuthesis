...
\centering
    ...
    \includegraphics[width=0.30\textwidth]{data/img/facemarker.pdf}}
    \hspace{5mm}
    \subcaptionbox{局部区域}{
    \label{fig:face_region}
    \includegraphics[width=0.30\textwidth]{data/img/faceregion.pdf}}
...
\centering
    ...
    \includegraphics[width=0.23\textwidth]{data/img/metric_likai_0380_00103.pdf}}
    \subcaptionbox{}{
    \label{fig:metric_lbp}
    \includegraphics[width=0.23\textwidth]{data/img/metric_lbp_00102.pdf}}
    \subcaptionbox{}{
    \label{fig:metric_mag}
    \includegraphics[width=0.23\textwidth]{data/img/metric_OFmag_00102.pdf}}
    \subcaptionbox{}{
    \label{fig:metric_magori}
    \includegraphics[width=0.23\textwidth]{data/img/metric_OFmagori_00102.pdf}}
